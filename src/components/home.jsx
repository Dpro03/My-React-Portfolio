  ...
  return (
    <div name="Home" className="w-full h-screen bg-gradient-to-r from-slate-900 to-rose-900">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        <p className="text-stone-300 text-2xl pb-4 underline">Hi, my name is</p>
        ...
        <div>
          <button className="text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-indigo-400 hover:border-black hover:text-black">
